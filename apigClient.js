...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://ohocsdryx3.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['f', 'x-amz-meta-customLabels'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['f', ]),
            body: body
        };
